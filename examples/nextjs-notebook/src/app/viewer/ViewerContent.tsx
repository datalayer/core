...
import { deleteRuntime } from '@datalayer/core/lib/api/runtimes/actions';
...
const NotebookViewer = dynamicImport(
  () => import('@/components/NotebookViewer'),
  {
    ssr: false,
    loading: () => (
      <Box
...
export default function ViewerContentWrapper() {
  return (
    <Suspense
      fallback={
        <Box
