...
<div className="sb-container">
  ...
  <div className="sb-section">
    <div className="sb-features-grid">
      ...
      <div className="sb-grid-item">
        <img src={Testing} alt="Screencapture of tests passing and failing" />
      ...
      <div className="sb-grid-item">
        <img src={Accessibility} alt="Screencapture of accessibility tests passing and failing" />
      ...
      <div className="sb-grid-item">
        <img src={Theming} alt="Screencapture of Storybook in light and dark mode" />
