...
import {Button, ButtonGroup, ButtonSizes, ButtonVariants, Text, TextProps, ThemeProvider, useWindowSize} from '@primer/react-brand'
        ...
        >
          <div ref={rootRef} className={styles['SubNav--header-container-outer']}>
            ...
            {LinkChildren.length && (
              ...
              >
                {ActionChild ? 
                  <li className={styles['SubNav__action-container']}>{ActionChild}</li>
                  :
                  <li className={styles['SubNav__action-container']}></li>
                }
                {LinkChildren}
                <ButtonGroup buttonSize="small">
                  <Button href="#" onClick={(e) => {window.location.assign("https://datalayer.app")}} hasArrow={true} variant="subtle">
                    Login
                  </Button>
                  {/*
