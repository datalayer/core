...
class DatalayerClient(
    DatalayerClientAuthMixin, EnvironmentsMixin, SecretsMixin, SnapshotsMixin
):
    """
...
class Runtime(DatalayerClientAuthMixin, RuntimesMixin, SnapshotsMixin):
    ...
    def __init__(
        ...
        self._pod_name: str = ""
        self._credits_limit: Optional[float] = None
    ...
    def start(self) -> None:
        ...
        'uid': '01k0cbydj3xg6zkysqp02y6msv',
        'pod_name': 'runtime-01k0cbydj3xg6zkysqp02y6msv',
        'type': 'notebook',
        'given_name': 'runtime-python-cpu-env-2416',
        'token': '75b51c2729d0fb96464623e8c8f9542b491f4607',
        'ingress': 'https://prod1.datalayer.run/jupyter/server/python-cpu-pool/01k0cbydj3xg6zkysqp02y6msv',
        'reservation_id': 'runtime-01k0cbydj3xg6zkysqp02y6msv',
        'started_at': '1752842951.000',
        'expired_at': '1752861131.803'}
        """
        if self._kernel_client is None:
            ...
            # self._kernel_client_info = runtime["kernel"]
