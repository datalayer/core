...
class UserData(BaseModel):
    ...
    join_request_ts_dt: Optional[datetime] = Field(None, description="Join request timestamp")
    join_ts_dt: Optional[datetime] = Field(None, description="Join timestamp")
    last_update_ts_dt: Optional[datetime] = Field(None, description="Last update timestamp")
    roles_ss: Optional[List[str]] = Field(default_factory=list, description="User roles")
...
class UserProfile(BaseModel):
    ...
    first_name: Optional[str] = Field(None, alias="firstName", description="User first name")
    last_name: Optional[str] = Field(None, alias="lastName", description="User last name")
...
class UserOnboarding(BaseModel):
    ...
    metadata: Optional[Dict[str, Any]] = Field(default_factory=dict, description="Onboarding metadata")
...
class OrganizationMember(BaseModel):
    ...
    roles_ss: List[str] = Field(default_factory=list, description="Member roles in organization")
...
class TeamMember(BaseModel):
    ...
    last_name_t: str = Field(..., description="Member last name")
    email_s: EmailStr = Field(..., description="Member email")
    roles_ss: List[str] = Field(default_factory=list, description="Member roles in team")
...
class ResourceRequirements(BaseModel):
    ...
    nvidia_gpu: Optional[str] = Field(None, alias="nvidia.com/gpu", description="GPU requirements")
...
class UsageData(BaseModel):
    ...
    pod_resources: Optional[ResourceRequirements] = Field(None, description="Pod resources")
    burning_rate: float = Field(..., description="Credits burning rate per second")
...
class CreditsUpdateRequest(BaseModel):
    ...
    operation: Optional[str] = Field(default="set", description="Operation type (set, add, subtract)")
...
class TokenData(BaseModel):
    ...
    expiration_ts_dt: Optional[datetime] = Field(None, description="Token expiration timestamp")
...
class OrganizationListResponseData(BaseModel):
    ...
    organizations: List[OrganizationData] = Field(..., description="List of organizations")
