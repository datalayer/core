...
from datalayer_core.mixins.runtime_snapshots import RuntimeSnapshotsDeleteMixin


class RuntimeSnapshotsDeleteApp(DatalayerCLIBaseApp, RuntimeSnapshotsDeleteMixin):
