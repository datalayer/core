...
from datalayer.kernels.utils import timestamp_to_local_date
from datalayer.utils.utils import fetch
...
class KernelManager(LoggingConfigurable):
    ...
    client_class = DottedObjectName("datalayer.kernels.client.KernelClient")
    client_factory = Type(klass="datalayer.kernels.client.KernelClient")
